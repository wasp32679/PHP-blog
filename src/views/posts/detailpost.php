...
<div class="container w-full max-w-6xl mx-auto mt-8 mb-16 rounded overflow-hidden">
    <img
        ...
        class="w-full max-h-[75vh] object-contain bg-gray-100 dark:bg-gray-900" />
</div>
...
<div class="container max-w-5xl mx-auto -mt-32">
    ...
    <div class="mx-0 sm:mx-6">
        ...
        <!--Content-->
        <div class=" w-full p-8 md:p-24 text-xl md:text-2xl text-gray-900 dark:text-white leading-normal" style="font-family:Georgia,serif;">
            <p class="wrap-break-word whitespace-pre-line"><?= htmlspecialchars($post->content, ENT_QUOTES, 'UTF-8') ?></p>
        </div>

        <!--Author-->
        <div class="flex w-full text-gray-900 dark:text-white items-center font-sans p-8 md:p-24">
