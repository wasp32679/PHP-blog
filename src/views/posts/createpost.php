...
<div class="min-h-screen flex flex-col items-start md:items-center justify-center md:p-8">
    ...
    <?php if (!empty($message)): ?>
        <?php if ($message === "Post successfully created!"): ?>
            <div class="mx-5 my-5 w-6xl flex items-center gap-3 rounded-lg border border-green-500/30 bg-green-500/10 px-9 py-3 text-xl text-green-400">
                <?= htmlspecialchars($message) ?>
            </div>
        <?php else: ?>
            <div class="mx-5 my-5 w-6xl flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 px-9 py-3 text-xl text-red-400">
                <?= htmlspecialchars($message) ?>
            </div>
        <?php endif; ?>
    <?php endif; ?>
