        ...
        <form method="POST" action="/posts/create" enctype="multipart/form-data">
            <div class="space-y-12 p-5 m-4">
                ...
                <?php if (!empty($errors['general'])): ?>
                    <div class="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 px-9 py-3 text-xl text-red-400">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed <?= !empty($errors['file']) ? 'border-red-500' : 'border-gray-900/25 dark:border-gray-600' ?> px-6 py-10">
                            <div class="text-center">
                                ...
                                <div class="mt-4 flex text-sm/6 text-gray-600 dark:text-gray-400">
                                    <label for="image" class="relative cursor-pointer rounded-md font-semibold text-indigo-600 dark:text-indigo-400 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 focus-within:outline-hidden hover:text-indigo-500">
